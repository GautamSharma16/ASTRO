        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((rev, idx) => (
            <motion.div
              ...
              className="p-8 rounded-2xl glass-card border border-gold-400/15 flex flex-col justify-between hover:shadow-xl hover:border-gold-400/30 transition-all duration-300 relative group"
            >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-gold-900/80 leading-relaxed font-light">
                      {rev.challenge}
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-gold-900/70 leading-relaxed font-light italic">
                      "{rev.remedy}"
                    </p>
                  </div>

                  <div className="space-y-1 pt-2">
                    <p className="text-[10px] font-bold text-green-700/80 uppercase tracking-widest">
                      The Result:
                    </p>
                    <p className="text-sm font-serif font-medium text-gold-900 leading-relaxed">
                      {rev.result}
                    </p>
                  </div>
                </div>
              ...
              {/* Author Info */}
              <div className="mt-8 pt-4 border-t border-gold-subtle/40">
                <p className="font-serif text-base font-semibold text-gold-900">
                  {rev.name}
                </p>
                <p className="text-[11px] text-gold-900/50 uppercase tracking-wider">
                  {rev.role}
                </p>
              </div>
            </motion.div>
